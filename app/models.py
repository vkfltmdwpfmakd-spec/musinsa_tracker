...
class Product(Base):
    ...
    category_depth1 = Column(String, nullable=True, comment='1단계 카테고리 (상의, 아우터 등)')
    category_depth1_code = Column(String, nullable=True, comment='1단계 카테고리 코드 (001, 002 등)')
    category_depth2 = Column(String, nullable=True, comment='2단계 카테고리 (반소매 티셔츠, 나일론 재킷 등)')
    category_depth2_code = Column(String, nullable=True, comment='2단계 카테고리 코드 (001001, 002003 등)')
    category_depth3 = Column(String, nullable=True, comment='3단계 카테고리 (상세 분류)')
    category_depth3_code = Column(String, nullable=True, comment='3단계 카테고리 코드 (001001001 등)')
